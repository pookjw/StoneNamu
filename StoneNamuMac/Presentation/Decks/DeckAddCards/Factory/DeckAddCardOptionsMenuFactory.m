...
+ (NSArray<NSMenuItem *> *)itemArrayFromDic:(NSDictionary<NSString *, NSString *> *)dic
    ...
    NSComparator comparator = ^NSComparisonResult(StorableMenuItem *lhsItem, StorableMenuItem *rhsItem) {
        NSUInteger lhs = converter(lhsItem.userInfo[DeckAddCardOptionsMenuFactoryStorableMenuItemValueKey]);
        NSUInteger rhs = converter(rhsItem.userInfo[DeckAddCardOptionsMenuFactoryStorableMenuItemValueKey]);
