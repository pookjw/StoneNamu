...
static BlizzardHSAPILocale const BlizzardHSAPILocaleItIT = @"it_IT"; // Italian
static BlizzardHSAPILocale const BlizzardHSAPILocaleJaJP = @"ja_JP"; // Japanese
static BlizzardHSAPILocale const BlizzardHSAPILocaleKoKR = @"ko_KR"; // Korean
static BlizzardHSAPILocale const BlizzardHSAPILocalePlPL = @"pl_PL"; // Polish
