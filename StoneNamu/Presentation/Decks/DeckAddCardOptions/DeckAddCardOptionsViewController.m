...
- (void)presentPickerEventReceived:(NSNotification *)notification {
    ...
    dispatch_async(queue, ^{
        ...
        NSDictionary<NSString *, NSString *> * _Nullable slugsAndNames = notification.userInfo[DeckAddCardOptionsViewModelPresentPickerNotificationSlugsAndNamesKey];
        NSSet<NSString *> * _Nullable values = notification.userInfo[DeckAddCardOptionsViewModelPresentPickerNotificationValuesItemKey];
        NSNumber * _Nullable showsEmptyRow = notification.userInfo[DeckAddCardOptionsViewModelPresentPickerNotificationShowsEmptyRowItemKey];
